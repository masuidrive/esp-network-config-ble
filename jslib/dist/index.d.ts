...
export declare type BLESmartConfigErrors =
...
export declare class BLESmartConfig {
  ...
  transitions: (
    | import("./fsm").ITransition<"Disconnected" | "Connected">
    | import("./fsm").ITransition<"Disconnected" | "Connecting">
    | import("./fsm").ITransition<"Connecting" | "Connected">
    | import("./fsm").ITransition<"Connected" | "Processing">
    | import("./fsm").ITransition<"Disconnected" | "Processing">
  )[];
  constructor(
    uart: BLEUART,
    onChange?: (prevState: States, currentState: States) => void | Promise<void>
